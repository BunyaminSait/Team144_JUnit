...
public class C03_TestNotasyonu {
    ...
    /*
        ...
        ve tek baslarina Run edilemez

        JUnit ile kazandigimiz en buyuk kolayliklarindan biri
        siradan method'lari @Test notasyonu sayesinde
        tek basina CALISABİLİR veya CALISTIRILABILIR method'lara donusturmektir
